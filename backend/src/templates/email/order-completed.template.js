          ...
          <tr>
            <td style="padding:40px 32px;">
              ...
              <p style="font-size:16px;line-height:1.7;color:#6A5952;">
                Your order has been marked as <strong>completed</strong>! We hope you are delighted with your products.
              </p>
              ...
              <p style="margin:24px 0 0;font-size:14px;line-height:1.6;color:#6A5952;">
                Thank you for supporting local farmers, cooperatives, and KapeKonek!
              </p>
            </td>
          </tr>
